...
Single YAML file (`esp32-cam.yaml`) defines the entire firmware. ESPHome compiles this into a custom ESP32 firmware.
...
- `wifi:` - Uses `!secret` references, includes fallback AP
...
- Board: `esp32dev` with Arduino framework
